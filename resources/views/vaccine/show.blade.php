        ...
        <div style="overflow:scroll; height: 65vh;">
            <table class="table text-center small stationery" style="border: 1px solid black; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="font-size: 12px; background-color: rgb(197, 162, 243); padding: 10px 0;">{{ $vaccine_headers->balance1 }}</td>
                    <td style="font-size: 12px; background-color: rgb(197, 162, 243); padding: 10px 0;">{{ $vaccine_headers->used1 }}</td>
                    <td style="font-size: 12px; background-color: rgb(197, 162, 243); padding: 10px 0;">{{ $vaccine_headers->adults1 }}</td>
                    <td style="font-size: 12px; background-color: rgb(197, 162, 243); padding: 10px 0;">{{ $vaccine_headers->children1 }}</td>
                    <td style="font-size: 12px; background-color: rgb(228, 245, 152); padding: 10px 0;">{{ $vaccine_headers->balance2 }}</td>
                    <td style="font-size: 12px; background-color: rgb(228, 245, 152); padding: 10px 0;">{{ $vaccine_headers->used2 }}</td>
                    <td style="font-size: 12px; background-color: rgb(228, 245, 152); padding: 10px 0;">{{ $vaccine_headers->adults2 }}</td>
                    <td style="font-size: 12px; background-color: rgb(228, 245, 152); padding: 10px 0;">{{ $vaccine_headers->children2 }}</td>
                    <td style="font-size: 12px; background-color: rgb(146, 190, 240); padding: 10px 0;">{{ $vaccine_headers->balance3 }}</td>
                    <td style="font-size: 12px; background-color: rgb(146, 190, 240); padding: 10px 0;">{{ $vaccine_headers->used3 }}</td>
                    <td style="font-size: 12px; background-color: rgb(146, 190, 240); padding: 10px 0;">{{ $vaccine_headers->adults3 }}</td>
                    <td style="font-size: 12px; background-color: rgb(146, 190, 240); padding: 10px 0;">{{ $vaccine_headers->children3 }}</td>
                    <td style="font-size: 12px; background-color: rgb(210, 224, 241); padding: 10px 0;">{{ $vaccine_headers->balance4 }}</td>
                    <td style="font-size: 12px; background-color: rgb(210, 224, 241); padding: 10px 0;">{{ $vaccine_headers->used4 }}</td>
                    <td style="font-size: 12px; background-color: rgb(210, 224, 241); padding: 10px 0;">{{ $vaccine_headers->adults4 }}</td>
                    <td style="font-size: 12px; background-color: rgb(210, 224, 241); padding: 10px 0;">{{ $vaccine_headers->children4 }}</td>
                    <td style="font-size: 12px; background-color: rgb(255, 154, 154); padding: 10px 0;">{{ $vaccine_headers->balance5 }}</td>
                    <td style="font-size: 12px; background-color: rgb(255, 154, 154); padding: 10px 0;">{{ $vaccine_headers->used5 }}</td>
                    <td style="font-size: 12px; background-color: rgb(255, 154, 154); padding: 10px 0;">{{ $vaccine_headers->adults5 }}</td>
                    <td style="font-size: 12px; background-color: rgb(255, 154, 154); padding: 10px 0;">{{ $vaccine_headers->children5 }}</td>
                </tr>
                @php
                    $asd = 1;
                @endphp
