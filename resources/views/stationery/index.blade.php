...
@section('content')
    ...
    <div class="container">
        ...
        {{-- <h3>Import</h3>
        <form action="{{ route('stationery.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
        ...
        <div style="overflow:scroll; height: 500px;">
            <table class="text-center small stationery" style="border: 1px solid black; border-collapse: collapse;">
                <tr>
                    <td rowspan="3"></td>
